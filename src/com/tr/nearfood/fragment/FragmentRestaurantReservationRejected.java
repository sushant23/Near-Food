...
import com.tr.nearfood.fragment.FragmentRestaurantOrderRejected.getCustomersOrder;
...
public class FragmentRestaurantReservationRejected extends Fragment {
	...
	public class getCustomersOrder extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... arg0) {
			...
			try {
				...
				json = httpGETConnection(AppConstants.RESTAURANT_VIEW_RESERVATION+"CANCELLED");
		...
		protected void onPostExecute(String result) {
			...
			listAdapter = new ExpandableListAdapter(getActivity(),
					listDataHeader, listDataChild,"REJECTED",AUTH,"RESERVE");
